...
CEOP
     ...
     &                        , phivGSR8, shareBufvGSR8
      Real*8  phiGSR8 (lShare8, 0:MAX_NO_THREADS )
      Real*8  shareBufGSR8 ( 1,1 ) ! ( nSx, nSy )
      Real*8  phivGSR8(lShare8, 0:MAX_NO_THREADS, -3:29, 1:20 ) ! 1-OLy:sNy+OLy, 1:nTilesY ) 
      Real*8  shareBufvGSR8 ( -3:29, 1, 1 ) ! ( 1-OLy:sNy+OLy, nSx, nSy )
